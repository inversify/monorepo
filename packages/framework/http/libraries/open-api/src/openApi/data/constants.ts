export const htmlTemplateString: string = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <title><% title %></title>
...
export const jsTemplateString: string = `
window.onload = function() {
  ...
  const customOptions = options.swaggerUiOptions
  const swaggerOptions = {
    spec: options.openApiObject,
    url: url,
