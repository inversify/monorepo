...
vitest.mock(
  import('../../actions/v3Dot1/toSchemaInControllerMetadataContext.js'),
);
vitest.mock(
  import('../../actions/v3Dot1/updateControllerOpenApiMetadataOperationProperty.js'),
);
...
import { OasRequestBody } from './OasRequestBody.js';
