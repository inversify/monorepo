...
vitest.mock(import('../../actions/v3Dot2/toSchemaInSchemaMetadataContext.js'));
vitest.mock(import('../../actions/v3Dot2/updateSchemaMetadataFromOptions.js'));
vitest.mock(import('../../actions/v3Dot2/updateSchemaMetadataSchema.js'));
...
describe(OasSchema, () => {
  ...
  describe('having a schema object parameter', () => {
    let schemaFixture: OpenApi3Dot2SchemaObject;
  ...
  describe('having a build function parameter', () => {
    let buildFunctionFixture: BuildOpenApiBlockFunction<OpenApi3Dot2SchemaObject>;
    let toSchemaFunctionMock: Mock<ToSchemaFunction>;
    let builtSchemaFixture: OpenApi3Dot2SchemaObject;
