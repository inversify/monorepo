...
vitest.mock(
  import('../../actions/v3Dot2/updateControllerOpenApiMetadataOperationRecordProperty.js'),
);
...
describe(OasResponse, () => {
  describe('having a response object parameter', () => {
    ...
    let responseFixture: OpenApi3Dot2ResponseObject;
  ...
  describe('having a build function parameter', () => {
    let codeFixture: HttpStatusCode;
    let buildFunctionFixture: BuildOpenApiBlockFunction<OpenApi3Dot2ResponseObject>;
    let toSchemaFunctionMock: Mock<ToSchemaFunction>;
    let builtResponseFixture: OpenApi3Dot2ResponseObject;
