...
vitest.mock(
  import('../../actions/v3Dot2/updateControllerOpenApiMetadataOperationProperty.js'),
);

import { type OpenApi3Dot2ExternalDocumentationObject } from '@inversifyjs/open-api-types/v3Dot2';
...
import { OasExternalDocs } from './OasExternalDocs.js';

describe(OasExternalDocs, () => {
  describe('having a prototype target, key and type descriptor', () => {
    let contentFixture: OpenApi3Dot2ExternalDocumentationObject;
