...
describe(toSchema, () => {
  ...
  describe('when called, and getOwnReflectMetadata() returns undefined', () => {
    ...
    it('should return an OpenApi3Dot2SchemaObject with $ref using escaped type.name', () => {
  ...
  describe('when called, and getOwnReflectMetadata() returns metadata with undefined name', () => {
    // eslint-disable-next-line @typescript-eslint/no-unsafe-function-type
    let typeFixture: Function;
    let metadataWithUndefinedName: OpenApiSchemaMetadata;
    let escapedNameFixture: string;
  ...
  describe('when called, and getOwnReflectMetadata() returns metadata with name', () => {
    // eslint-disable-next-line @typescript-eslint/no-unsafe-function-type
    let typeFixture: Function;
    let metadataWithName: OpenApiSchemaMetadata;
    ...
    it('should return an OpenApi3Dot2SchemaObject with $ref using escaped metadata.name', () => {
      expect(result).toStrictEqual({
        $ref: `#/components/schemas/${escapedNameFixture}`,
      });
    });
