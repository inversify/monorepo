...
>([
  ...
  'having OpenApi3Dot2Object with %s',
  (
    _: string,
    openApi3Dot2ObjectFixture: OpenApi3Dot2Object,
    pathFixture: string,
    pathItemObjectFixture: OpenApi3Dot2PathItemObject,
    expectedResult: OpenApi3Dot2Object,
  ) => {
