...
const SCHEMA_ID: string = 'openapi-v3dot2-spec';
...
export class OpenApiValidationPipe implements Pipe {
  ...
  #resolveContentType(metadata: PipeMetadata): string {
    ...
    const requestBody: OpenApi3Dot2RequestBodyObject | undefined =
      operationObject.requestBody as OpenApi3Dot2RequestBodyObject | undefined;
