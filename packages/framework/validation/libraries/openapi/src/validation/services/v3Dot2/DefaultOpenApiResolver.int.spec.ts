...
describe(DefaultOpenApiResolver, () => {
  ...
  describe('having an OpenAPI object with request body components', () => {
    ...
    let userBodyFixture: NonNullable<
      NonNullable<OpenApi3Dot2Object['components']>['requestBodies']
    >[string];
              ...
              chain: [
                {
                  $ref: '#/components/requestBodies/User',
                  canonicalId:
                    'urn:inversifyjs:openapi-v3dot2-spec#/components/requestBodies/User',
                  value: {
                    $ref: '#/components/requestBodies/User',
                  },
                },
              ...
              resolutionContextStack: [
                {
                  $ref: '#/components/requestBodies/Missing',
                  canonicalId:
                    'urn:inversifyjs:openapi-v3dot2-spec#/components/requestBodies/Missing',
                },
              ],
            },
          });
          ...
          expect(result).toStrictEqual({
            ...
            value: {
              ...
              resolutionContextStack: [
                {
                  $ref: '#item',
                  canonicalId: 'urn:inversifyjs:openapi-v3dot2-spec#item',
                },
              ],
            },
          });
