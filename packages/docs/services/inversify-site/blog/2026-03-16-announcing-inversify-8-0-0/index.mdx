...
```bash
npm install inversify@8.0.0
```

```bash
pnpm add inversify@8.0.0
```

```bash
yarn add inversify@8.0.0
```

## Thank You

A huge thank you to everyone who tested the beta and provided feedback — your reports and suggestions directly shaped the quality of this release. We're excited to see what you build with InversifyJS 8!

If you encounter any issues, please open an issue on the [InversifyJS monorepo](https://github.com/inversify/monorepo).
