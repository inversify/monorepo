...
import decoratorApiInjectFromHierarchyConstructorArgumentSource from '@inversifyjs/code-examples/generated/examples/v7/decoratorApiInjectFromHierarchyConstructorArguments.ts.txt';
import decoratorApiInjectFromHierarchyPropertiesSource from '@inversifyjs/code-examples/generated/examples/v7/decoratorApiInjectFromHierarchyProperties.ts.txt';
