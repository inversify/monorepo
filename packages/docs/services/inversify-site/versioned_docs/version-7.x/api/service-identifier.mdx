...
---
import serviceIdentifierApiSource from '@inversifyjs/code-examples/generated/examples/v7/serviceIdentifierApi.ts.txt'
...
<Info title="Type Inference support">
...
<Warning title="Assignment reduced type">
