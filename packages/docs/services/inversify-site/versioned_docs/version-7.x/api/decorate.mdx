...
title: decorate
---
import decorateClassDecoratorSource from '@inversifyjs/code-examples/generated/examples/v7/decorateClassDecorator.ts.txt';
import decorateParameterDecoratorSource from '@inversifyjs/code-examples/generated/examples/v7/decorateParameterDecorator.ts.txt';
import decoratePropertyDecoratorSource from '@inversifyjs/code-examples/generated/examples/v7/decoratePropertyDecorator.ts.txt';
import decorateMethodDecoratorSource from '@inversifyjs/code-examples/generated/examples/v7/decorateMethodDecorator.ts.txt';
