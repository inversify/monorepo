...
Retrieves the native request object of the current adapter (Express 4, Express 5, Fastify, or Hono). Useful when you need full access to the underlying framework request.
