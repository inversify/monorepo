...
```bash
  npm install @inversifyjs/http-express @inversifyjs/express-open-api
```
...
```bash
  npm install @inversifyjs/http-fastify @inversifyjs/fastify-open-api
```
...
```bash
  npm install @inversifyjs/http-hono @inversifyjs/hono-open-api
```
