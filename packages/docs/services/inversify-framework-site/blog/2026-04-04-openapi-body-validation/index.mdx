...
title: "OpenAPI Validation — Your Spec Is Your Schema"
...
This package reads the OpenAPI schemas you defined through `@inversifyjs/http-open-api`, compiles them with [Ajv](https://ajv.js.org/), and validates incoming request bodies and headers automatically. **Zero extra schema definitions. Zero drift.**
