...
<Tabs groupId="package-manager">
  <TabItem value="npm" label="npm">
    ```bash
    npm install @inversifyjs/http-express-v4 express4 inversify reflect-metadata
    ```
  </TabItem>
  <TabItem value="yarn" label="yarn">
    ```bash
    yarn add @inversifyjs/http-express-v4 express4 inversify reflect-metadata
    ```
  </TabItem>
  <TabItem value="pnpm" label="pnpm">
    ```bash
    pnpm add @inversifyjs/http-express-v4 express4 inversify reflect-metadata
    ```
  </TabItem>
</Tabs>
