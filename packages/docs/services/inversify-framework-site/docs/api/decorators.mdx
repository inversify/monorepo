...
Asuming an auth middleware lets user details in a `user` property of a given `request`, we can easily create a custom decorator to provide such user details as follows:
