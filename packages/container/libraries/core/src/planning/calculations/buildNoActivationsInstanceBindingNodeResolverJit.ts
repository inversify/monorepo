 ...
 */
export function buildNoActivationsInstanceBindingNodeResolverJit<TActivated>(
  ...
  switch (
    ...
    case ZERO_CONSTRUCTOR_ARGUMENTS:
      resolveNode = buildZeroConstructorArgumentsResolverJit(
        implementationType,
        resolveActivations,
      );
      break;
    ...
    case TWO_CONSTRUCTOR_ARGUMENTS:
      resolveNode = buildConstructorArgumentsResolverJit(
        node,
        implementationType,
        resolveTwo,
        resolveActivations,
