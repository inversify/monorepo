...
@Module({
  exports: [WideService],
  providers: [Parameter, WideService],
})
class ContainerModule {}

export class NestCoreGetWideServiceInTransientScopeScenario implements Scenario<Platform> {
  ...
  public async execute(): Promise<void> {
    await this.#context.resolve(WideService);
  }
}
