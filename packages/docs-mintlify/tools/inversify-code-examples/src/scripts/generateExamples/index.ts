...
const EXAMPLES_SUBPATH: string = 'src/examples';
const OUTPUT_FOLDER: string = '../../code-examples';
...
async function writeSourceCodeExample(
  ...
  const destinationPath: string = `${sourcePath.replace(EXAMPLES_SUBPATH, OUTPUT_FOLDER)}.txt`;
