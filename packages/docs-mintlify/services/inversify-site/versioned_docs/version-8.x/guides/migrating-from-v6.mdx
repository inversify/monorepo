...
import containerApiGetAllWithNamedBindingsSource from '../../../snippets/code-examples/examples/v8/containerApiGetAllWithNamedBindings.ts';
import containerApiGetNamedSource from '../../../snippets/code-examples/examples/v8/containerApiGetNamed.ts';
import containerModuleApiExampleSource from '../../../snippets/code-examples/examples/v8/containerModuleApiExample.ts';
...
import migrationToAutoFactorySource from '../../../snippets/code-examples/examples/v8/migrationToAutoFactory.ts';
import migrationToAutoNamedFactorySource from '../../../snippets/code-examples/examples/v8/migrationToAutoNamedFactory.ts';
import migrationToConstructorSource from '../../../snippets/code-examples/examples/v8/migrationToConstructor.ts';
import migrationToFunctionSource from '../../../snippets/code-examples/examples/v8/migrationToFunction.ts';
import migrationToProviderSource from '../../../snippets/code-examples/examples/v8/migrationToProvider.ts';
