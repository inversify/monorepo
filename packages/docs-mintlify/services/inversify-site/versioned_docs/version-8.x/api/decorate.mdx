...
title: decorate
---
import decorateClassDecoratorSource from '../../../snippets/code-examples/examples/v8/decorateClassDecorator.ts';
import decorateParameterDecoratorSource from '../../../snippets/code-examples/examples/v8/decorateParameterDecorator.ts';
import decoratePropertyDecoratorSource from '../../../snippets/code-examples/examples/v8/decoratePropertyDecorator.ts';
import decorateMethodDecoratorSource from '../../../snippets/code-examples/examples/v8/decorateMethodDecorator.ts';
