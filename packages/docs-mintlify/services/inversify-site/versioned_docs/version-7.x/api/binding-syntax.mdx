...
---
import bindingOnSyntaxApiOnActivationSource from '../../../snippets/code-examples/examples/v7/bindingOnSyntaxApiOnActivation.ts';
import bindingToSyntaxApiToSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiTo.ts';
import bindingToSyntaxApiToConstantValueSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToConstantValue.ts';
import bindingToSyntaxApiToDynamicValueSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToDynamicValue.ts';
import bindingToSyntaxApiToFactorySource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToFactory.ts';
import bindingToSyntaxApiToProviderSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToProvider.ts';
import bindingToSyntaxApiToResolvedValueSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToResolvedValue.ts';
import bindingToSyntaxApiToResolvedValueAdvancedSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToResolvedValueAdvanced.ts';
import bindingToSyntaxApiToSelfSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToSelf.ts';
import bindingToSyntaxApiToServiceSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToService.ts';
import bindingSyntaxApiGetIdentifierSource from '../../../snippets/code-examples/examples/v7/bindingSyntaxApiGetIdentifier.ts';
import bindingWhenSyntaxApiWhenSource from '../../../snippets/code-examples/examples/v7/bindingWhenSyntaxApiWhen.ts';
...
<Warning title=":::warning Deprecated">
