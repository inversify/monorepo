...
title: decorate
---
import decorateClassDecoratorSource from '../../../snippets/code-examples/examples/v7/decorateClassDecorator.ts';
import decorateParameterDecoratorSource from '../../../snippets/code-examples/examples/v7/decorateParameterDecorator.ts';
import decoratePropertyDecoratorSource from '../../../snippets/code-examples/examples/v7/decoratePropertyDecorator.ts';
import decorateMethodDecoratorSource from '../../../snippets/code-examples/examples/v7/decorateMethodDecorator.ts';
