...
title: Decorator
---
import decoratorApiInjectConstructorArgumentSource from '../../../snippets/code-examples/examples/v7/decoratorApiInjectConstructorArgument.ts';
import decoratorApiInjectFromBaseConstructorArgumentSource from '../../../snippets/code-examples/examples/v7/decoratorApiInjectFromBaseConstructorArguments.ts';
import decoratorApiInjectFromBasePropertiesSource from '../../../snippets/code-examples/examples/v7/decoratorApiInjectFromBaseProperties.ts';
import decoratorApiInjectFromHierarchyConstructorArgumentSource from '../../../snippets/code-examples/examples/v7/decoratorApiInjectFromHierarchyConstructorArguments.ts';
import decoratorApiInjectFromHierarchyPropertiesSource from '../../../snippets/code-examples/examples/v7/decoratorApiInjectFromHierarchyProperties.ts';
import decoratorApiInjectPropertySource from '../../../snippets/code-examples/examples/v7/decoratorApiInjectProperty.ts';
import decoratorApiMultiInjectPropertySource from '../../../snippets/code-examples/examples/v7/decoratorApiMultiInjectProperty.ts';
import decoratorApiNamedSource from '../../../snippets/code-examples/examples/v7/decoratorApiNamed.ts';
import decoratorApiOptionalSource from '../../../snippets/code-examples/examples/v7/decoratorApiOptional.ts';
import decoratorApiPostConstructSource from '../../../snippets/code-examples/examples/v7/decoratorApiPostConstruct.ts';
import decoratorApiPreDestroySource from '../../../snippets/code-examples/examples/v7/decoratorApiPreDestroy.ts';
import decoratorApiTaggedSource from '../../../snippets/code-examples/examples/v7/decoratorApiTagged.ts';
import decoratorApiUnmanagedSource from '../../../snippets/code-examples/examples/v7/decoratorApiUnmanaged.ts';
