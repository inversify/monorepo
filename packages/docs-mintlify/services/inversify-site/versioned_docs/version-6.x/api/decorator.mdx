...
title: Decorator
---
import decoratorApiInjectConstructorArgumentSource from '../../../snippets/code-examples/examples/decoratorApiInjectConstructorArgument.ts';
import decoratorApiInjectPropertySource from '../../../snippets/code-examples/examples/decoratorApiInjectProperty.ts';
import decoratorApiMultiInjectPropertySource from '../../../snippets/code-examples/examples/decoratorApiMultiInjectProperty.ts';
import decoratorApiNamedSource from '../../../snippets/code-examples/examples/decoratorApiNamed.ts';
import decoratorApiOptionalSource from '../../../snippets/code-examples/examples/decoratorApiOptional.ts';
import decoratorApiPostConstructSource from '../../../snippets/code-examples/examples/decoratorApiPostConstruct.ts';
import decoratorApiPreDestroySource from '../../../snippets/code-examples/examples/decoratorApiPreDestroy.ts';
import decoratorApiTaggedSource from '../../../snippets/code-examples/examples/decoratorApiTagged.ts';
import decoratorApiUnmanagedSource from '../../../snippets/code-examples/examples/decoratorApiUnmanaged.ts';
