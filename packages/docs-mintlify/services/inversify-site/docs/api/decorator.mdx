...
title: Decorator
---
import decoratorApiInjectConstructorArgumentSource from '../../snippets/code-examples/examples/v8/decoratorApiInjectConstructorArgument.ts';
import decoratorApiInjectFromBaseConstructorArgumentSource from '../../snippets/code-examples/examples/v8/decoratorApiInjectFromBaseConstructorArguments.ts';
import decoratorApiInjectFromBasePropertiesSource from '../../snippets/code-examples/examples/v8/decoratorApiInjectFromBaseProperties.ts';
import decoratorApiInjectFromHierarchyConstructorArgumentSource from '../../snippets/code-examples/examples/v8/decoratorApiInjectFromHierarchyConstructorArguments.ts';
import decoratorApiInjectFromHierarchyPropertiesSource from '../../snippets/code-examples/examples/v8/decoratorApiInjectFromHierarchyProperties.ts';
import decoratorApiInjectPropertySource from '../../snippets/code-examples/examples/v8/decoratorApiInjectProperty.ts';
import decoratorApiMultiInjectPropertySource from '../../snippets/code-examples/examples/v8/decoratorApiMultiInjectProperty.ts';
import decoratorApiNamedSource from '../../snippets/code-examples/examples/v8/decoratorApiNamed.ts';
import decoratorApiOptionalSource from '../../snippets/code-examples/examples/v8/decoratorApiOptional.ts';
import decoratorApiPostConstructSource from '../../snippets/code-examples/examples/v8/decoratorApiPostConstruct.ts';
import decoratorApiPreDestroySource from '../../snippets/code-examples/examples/v8/decoratorApiPreDestroy.ts';
import decoratorApiTaggedSource from '../../snippets/code-examples/examples/v8/decoratorApiTagged.ts';
import decoratorApiUnmanagedSource from '../../snippets/code-examples/examples/v8/decoratorApiUnmanaged.ts';
