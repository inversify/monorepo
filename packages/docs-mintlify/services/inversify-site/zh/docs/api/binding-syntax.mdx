...
title: 绑定语法
---
import bindingOnSyntaxApiOnActivationSource from '../../../snippets/code-examples/examples/v8/bindingOnSyntaxApiOnActivation.ts';
import bindingToSyntaxApiToSource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiTo.ts';
import bindingToSyntaxApiToConstantValueSource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiToConstantValue.ts';
import bindingToSyntaxApiToDynamicValueSource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiToDynamicValue.ts';
import bindingToSyntaxApiToFactorySource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiToFactory.ts';
import bindingToSyntaxApiToResolvedValueSource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiToResolvedValue.ts';
import bindingToSyntaxApiToResolvedValueAdvancedSource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiToResolvedValueAdvanced.ts';
import bindingToSyntaxApiToSelfSource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiToSelf.ts';
import bindingToSyntaxApiToServiceSource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiToService.ts';
import bindingSyntaxApiGetIdentifierSource from '../../../snippets/code-examples/examples/v8/bindingSyntaxApiGetIdentifier.ts';
import bindingWhenSyntaxApiWhenSource from '../../../snippets/code-examples/examples/v8/bindingWhenSyntaxApiWhen.ts';
