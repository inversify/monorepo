...
title: 从 v7 迁移
---
import migrationV7LoadV7Source from '../../../snippets/code-examples/examples/v7/migrationV7Load.ts';
import migrationV7LoadV8Source from '../../../snippets/code-examples/examples/v8/migrationV7Load.ts';
import migrationV7UnbindV7Source from '../../../snippets/code-examples/examples/v7/migrationV7Unbind.ts';
import migrationV7UnbindV8Source from '../../../snippets/code-examples/examples/v8/migrationV7Unbind.ts';
import migrationV7UnbindAllV7Source from '../../../snippets/code-examples/examples/v7/migrationV7UnbindAll.ts';
import migrationV7UnbindAllV8Source from '../../../snippets/code-examples/examples/v8/migrationV7UnbindAll.ts';
import migrationV7RebindV7Source from '../../../snippets/code-examples/examples/v7/migrationV7Rebind.ts';
import migrationV7RebindV8Source from '../../../snippets/code-examples/examples/v8/migrationV7Rebind.ts';
import migrationV7UnloadV7Source from '../../../snippets/code-examples/examples/v7/migrationV7Unload.ts';
import migrationV7UnloadV8Source from '../../../snippets/code-examples/examples/v8/migrationV7Unload.ts';
import migrationV7ContainerModuleOptionsV7Source from '../../../snippets/code-examples/examples/v7/migrationV7ContainerModuleOptions.ts';
import migrationV7ContainerModuleOptionsV8Source from '../../../snippets/code-examples/examples/v8/migrationV7ContainerModuleOptions.ts';
import migrationV7ToProviderV7Source from '../../../snippets/code-examples/examples/v7/migrationV7ToProvider.ts';
import migrationV7ToProviderV8Source from '../../../snippets/code-examples/examples/v8/migrationV7ToProvider.ts';
