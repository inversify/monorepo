...
import DecorateClassDecoratorSource from '../../snippets/code-examples/examples/v8/decorateClassDecorator.ts.md';
import DecorateParameterDecoratorSource from '../../snippets/code-examples/examples/v8/decorateParameterDecorator.ts.md';
import DecoratePropertyDecoratorSource from '../../snippets/code-examples/examples/v8/decoratePropertyDecorator.ts.md';
import DecorateMethodDecoratorSource from '../../snippets/code-examples/examples/v8/decorateMethodDecorator.ts.md';
