...
import ContainerApiGetAllSource from '../../../snippets/code-examples/examples/v8/containerApiGetAll.ts.md';
import ContainerApiGetAllAsyncSource from '../../../snippets/code-examples/examples/v8/containerApiGetAllAsync.ts.md';
import ContainerApiGetAsyncSource from '../../../snippets/code-examples/examples/v8/containerApiGetAsync.ts.md';
import ContainerApiGetSource from '../../../snippets/code-examples/examples/v8/containerApiGet.ts.md';
import ContainerApiIsBoundSource from '../../../snippets/code-examples/examples/v8/containerApiIsBound.ts.md';
import ContainerApiIsCurrentBoundSource from '../../../snippets/code-examples/examples/v8/containerApiIsCurrentBound.ts.md';
import ContainerApiOnActivationSource from '../../../snippets/code-examples/examples/v8/containerApiOnActivation.ts.md';
import ContainerApiOnDeactivationSource from '../../../snippets/code-examples/examples/v8/containerApiOnDeactivation.ts.md';
import ContainerApiUnbindBindingIdSource from '../../../snippets/code-examples/examples/v8/containerApiUnbindBindingId.ts.md';
import ContainerApiUnbindSyncSource from '../../../snippets/code-examples/examples/v8/containerApiUnbindSync.ts.md';
import ContainerApiRebindSource from '../../../snippets/code-examples/examples/v8/containerApiRebind.ts.md';
import ContainerApiRebindSyncSource from '../../../snippets/code-examples/examples/v8/containerApiRebindSync.ts.md';
...
<Info>
  Unless specified otherwise, binding scopes are
  [transient](fundamentals/binding.mdx#transient) by default.
</Info>
...
<ContainerApiUnbindSyncSource />

### Example: Unbind a binding by its identifier

<ContainerApiUnbindBindingIdSource />
