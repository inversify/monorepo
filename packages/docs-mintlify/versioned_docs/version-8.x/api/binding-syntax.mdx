...
import BindingToSyntaxApiToSource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiTo.ts.md';
import BindingToSyntaxApiToConstantValueSource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiToConstantValue.ts.md';
import BindingToSyntaxApiToDynamicValueSource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiToDynamicValue.ts.md';
import BindingToSyntaxApiToFactorySource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiToFactory.ts.md';
import BindingToSyntaxApiToResolvedValueSource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiToResolvedValue.ts.md';
import BindingToSyntaxApiToResolvedValueAdvancedSource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiToResolvedValueAdvanced.ts.md';
import BindingToSyntaxApiToSelfSource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiToSelf.ts.md';
import BindingToSyntaxApiToServiceSource from '../../../snippets/code-examples/examples/v8/bindingToSyntaxApiToService.ts.md';
import BindingSyntaxApiGetIdentifierSource from '../../../snippets/code-examples/examples/v8/bindingSyntaxApiGetIdentifier.ts.md';
...
<Warning>
  Only singleton scoped bindings can have deactivation handlers. If you try to
  add a deactivation handler to a non-singleton binding, an error will be
  thrown.
</Warning>
