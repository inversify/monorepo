...
import BindingOnSyntaxApiOnActivationSource from '../../../snippets/code-examples/examples/v7/bindingOnSyntaxApiOnActivation.ts.md'
import BindingToSyntaxApiToSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiTo.ts.md'
import BindingToSyntaxApiToConstantValueSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToConstantValue.ts.md'
import BindingToSyntaxApiToDynamicValueSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToDynamicValue.ts.md'
import BindingToSyntaxApiToFactorySource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToFactory.ts.md'
import BindingToSyntaxApiToProviderSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToProvider.ts.md'
import BindingToSyntaxApiToResolvedValueSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToResolvedValue.ts.md'
import BindingToSyntaxApiToResolvedValueAdvancedSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToResolvedValueAdvanced.ts.md'
import BindingToSyntaxApiToSelfSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToSelf.ts.md'
import BindingToSyntaxApiToServiceSource from '../../../snippets/code-examples/examples/v7/bindingToSyntaxApiToService.ts.md'
import BindingSyntaxApiGetIdentifierSource from '../../../snippets/code-examples/examples/v7/bindingSyntaxApiGetIdentifier.ts.md'
import BindingWhenSyntaxApiWhenSource from '../../../snippets/code-examples/examples/v7/bindingWhenSyntaxApiWhen.ts.md'
...
<BindingSyntaxApiGetIdentifierSource />
...
`toProvider()` is deprecated and will be removed in v8. Use `toFactory()` instead.

Providers exist for historical reasons from v5 when async dependencies weren't supported. In v6+, async dependencies are supported, making providers obsolete. Factories are more flexible and can handle both synchronous and asynchronous operations.
...
<BindingToSyntaxApiToResolvedValueSource />

You can also provide more detailed options in order to received resolved services:

<BindingToSyntaxApiToResolvedValueAdvancedSource />
