...
import DecoratorApiInjectConstructorArgumentSource from '../../../snippets/code-examples/examples/v7/decoratorApiInjectConstructorArgument.ts.md'
import DecoratorApiInjectFromBaseConstructorArgumentSource from '../../../snippets/code-examples/examples/v7/decoratorApiInjectFromBaseConstructorArguments.ts.md'
import DecoratorApiInjectFromBasePropertiesSource from '../../../snippets/code-examples/examples/v7/decoratorApiInjectFromBaseProperties.ts.md'
import DecoratorApiInjectFromHierarchyConstructorArgumentSource from '../../../snippets/code-examples/examples/v7/decoratorApiInjectFromHierarchyConstructorArguments.ts.md'
import DecoratorApiInjectFromHierarchyPropertiesSource from '../../../snippets/code-examples/examples/v7/decoratorApiInjectFromHierarchyProperties.ts.md'
import DecoratorApiInjectPropertySource from '../../../snippets/code-examples/examples/v7/decoratorApiInjectProperty.ts.md'
import DecoratorApiMultiInjectPropertySource from '../../../snippets/code-examples/examples/v7/decoratorApiMultiInjectProperty.ts.md'
import DecoratorApiNamedSource from '../../../snippets/code-examples/examples/v7/decoratorApiNamed.ts.md'
import DecoratorApiOptionalSource from '../../../snippets/code-examples/examples/v7/decoratorApiOptional.ts.md'
import DecoratorApiPostConstructSource from '../../../snippets/code-examples/examples/v7/decoratorApiPostConstruct.ts.md'
import DecoratorApiPreDestroySource from '../../../snippets/code-examples/examples/v7/decoratorApiPreDestroy.ts.md'
import DecoratorApiTaggedSource from '../../../snippets/code-examples/examples/v7/decoratorApiTagged.ts.md'
import DecoratorApiUnmanagedSource from '../../../snippets/code-examples/examples/v7/decoratorApiUnmanaged.ts.md'
...
- `lifecycle` (object, optional): Lifecycle options for extending lifecycle methods from the base class:
  - `extendPostConstructMethods` (boolean, defaults to true): If true, post-construct methods from the base class will be extended.
  - `extendPreDestroyMethods` (boolean, defaults to true): If true, pre-destroy methods from the base class will be extended.

### Example: decorating base class constructor arguments

<DecoratorApiInjectFromBaseConstructorArgumentSource />

### Example: decorating base class properties

<DecoratorApiInjectFromBasePropertiesSource />
...
- `extendConstructorArguments` (boolean, defaults to true): If true, constructor arguments from all ancestors will be injected.
- `extendProperties` (boolean, defaults to true): If true, properties from all ancestors will be injected.
- `lifecycle` (object, optional): Lifecycle options for extending lifecycle methods from the hierarchy:
  - `extendPostConstructMethods` (boolean, defaults to true): If true, post-construct methods from all ancestors will be extended.
  - `extendPreDestroyMethods` (boolean, defaults to true): If true, pre-destroy methods from all ancestors will be extended.

### Example: decorating hierarchy constructor arguments

<DecoratorApiInjectFromHierarchyConstructorArgumentSource />

### Example: decorating hierarchy properties

<DecoratorApiInjectFromHierarchyPropertiesSource />
